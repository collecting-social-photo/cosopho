<template>
  <div class="container">
    <h1 :style="`color:#${$store.state.instance.colour};`">Select an initiative</h1>
    ...
    <div>
      <md-button :style="`background-color:#${$store.state.instance.colour};color:#fff;`" :disabled="disabled" @click="goToUpload()">Start Uploading</md-button>
    </div>
  </div>
</template>
